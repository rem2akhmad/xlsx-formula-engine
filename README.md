...
A standalone .xlsx recalculation engine for Kotlin/JVM: no external dependencies, direct file reading, and support for evaluating individual cells or whole workbooks.
