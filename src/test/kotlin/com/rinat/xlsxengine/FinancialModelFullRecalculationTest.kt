...
class FinancialModelFullRecalculationTest {
    private val workbookFile = "Financial+Model.xlsx"

    @Test
    fun `should recalculate all cells on all sheets for financial model`() {
        ...
        assertTrue(
            mismatches.isEmpty(),
            "Financial model recalculation mismatches=${mismatches.size}, totalCells=$totalCells, " +
